...
class editGlucose extends StatefulWidget {
  final DateTime time;
  final String title;
  final String id;
  ...
  @override
  _editGlucose createState() => _editGlucose();
}

class _editGlucose extends State<editGlucose> {
  late DateTime initialTime1;
  late String initialTitle;
  late String initialId;
  late double initialreading;
  ...
  void initState() {
    ...
    initialId = widget.id;
    initialreading = widget.glucoseReading;
  ...
  late TextEditingController initialreading1 =
      TextEditingController(text: initialreading.toStringAsFixed(0));
...
// Form submission method
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      print("id");
      print(initialId);
      sevice.deleteGlucoseReading(initialId);
            ...
            return AlertDialog(
              content: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 25),
                  Text(
                    'Glucose is Edited successfully!',
