...
class editPhysicalActivity extends StatefulWidget {
  final String type;
  final int duration;
  final DateTime time;
  final String title;
  ...
  @override
  _editPhysicalActivity createState() => _editPhysicalActivity();
}

class _editPhysicalActivity extends State<editPhysicalActivity> {
  ...
  void initState() {
    ...
    _selectedIntensity = initialType;
  }

  late TextEditingController initialTitle1 =
      TextEditingController(text: initialTitle);
  late TextEditingController initialDDuration1 =
      TextEditingController(text: initialDuration.toStringAsFixed(0));
...
// form submission method
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate() && _errorMessage == null) {
      ...
      sevice.deleteWorkout(initialId);
            ...
            return AlertDialog(
              content: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 25),
                  Text(
                    'Physical activity is edited successfully!',
            ...
            return AlertDialog(
              content: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 25),
                  Text(
                    'Failed editing the physical activity!',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 22),
                  ),
                  SizedBox(height: 15),
