...
class corrDose extends StatefulWidget {
  final bool? fromDosePage;
  final meal? currentMeal;
  final String? mealId;
  final InsulinDosage? insulinDosage;
  ...
  @override
  _corrDose createState() => _corrDose();
}

class _corrDose extends State<corrDose> {
  String _title = "";
...
// form submission method
  void _submitForm() async {
    if (_formKey.currentState!.validate() && _errorMessage == null) {
      ...
      // Determine if the dose is recommended
      bool isRecommended = widget.insulinDosage != null &&
          _amountdouble == widget.insulinDosage!.dosage;
  ...
  Future<double> _fetchCorrectionFactor() async {
  ...
  Future<void> _initializeCorrectionFactor() async {
    double factor = await _fetchCorrectionFactor();
    setState(() {
  ...
  Widget build(BuildContext context) {
    // Pre-fill the fields if an InsulinDosage is provided
    if (widget.insulinDosage != null) {
      _selectedType = 'Bolus'; // Pre-select Short Acting
      _selectedType2 = 'Short Acting';
      _amount =
          widget.insulinDosage!.dosage.toString(); // Pre-fill insulin amount
      _title = 'Correction Dose'; // Pre-fill title
    }
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              focusNode: myfocus,
                              initialValue: _title, // Pre-fill title
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    initialValue:
                                        _amount, // Pre-fill insulin amount
                                    decoration: InputDecoration(
                                      hintText:
                                    ...
                                    validator: (value) {
                                      ...
                                      // Check if the value matches the initial value
                                      if (widget.insulinDosage != null &&
                                          value ==
                                              widget.insulinDosage!.dosage
                                                  .toString()) {
                                        _amount = value;
                                        return null; // Mark as valid
                                      }
                                      _amount = value;
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    key: ValueKey(correctionFactor),
                                    initialValue:
                                        correctionFactor?.toStringAsFixed(1) ??
                                            ' ',
                                    decoration: InputDecoration(
                                      filled: true,
                                      fillColor: Colors.grey[100],
